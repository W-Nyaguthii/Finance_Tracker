...
import 'package:finance_tracker/screens/savings/views/savings_popup.dart';
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(
                'Current amount: Ksh ${savings.currentAmount.toStringAsFixed(2)}'),
            SizedBox(height: 20),
            TextFormField(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              "Saved: Ksh ${savings.currentAmount.toStringAsFixed(2)}",
                                              style: TextStyle(
                                                fontSize: 13,
